...
"""autogenerated by genpy from proyecto_final/HandActionResult.msg. Do not edit."""
import codecs
import sys
...
class HandActionResult(genpy.Message):
  _md5sum = "c1398fe481ec688645caf4fea4973474"
  _type = "proyecto_final/HandActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','proyecto_final/HandResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(HandActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = proyecto_final.msg.HandResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = proyecto_final.msg.HandResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.result.hand_data)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.hand_data:
        _x = val1
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result.hand_data.append(val1)
      return self
