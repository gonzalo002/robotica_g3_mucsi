...
"""autogenerated by genpy from proyecto_final/CubosActionResult.msg. Do not edit."""
import codecs
import sys
...
class CubosActionResult(genpy.Message):
  _md5sum = "fa5dd405c68f82e7d83daa221ff34ca8"
  _type = "proyecto_final/CubosActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','proyecto_final/CubosResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CubosActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = proyecto_final.msg.CubosResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = proyecto_final.msg.CubosResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.result.cubes_position)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.cubes_position:
        _x = val1.color
        buff.write(_get_struct_b().pack(_x))
        _v1 = val1.pose
        _v2 = _v1.position
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result.cubes_position.append(val1)
      return self
