...
class HandActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = HandGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new HandActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = HandGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new HandGoal()
    }
