...
class RoboticaTkinter:
    ...
    def cb_image_top(self, image:Image)->None:
        ...
        img = Image.fromarray(cv2.cvtColor(img, cv2.COLOR_BGR2RGB))  # Convertir de nuevo a RGB para PIL
    ...
    def update_image(self, img: Image, label:ttk.Label):
    ...
    def command_calibrate_aruco(self):
        ...
        if self.Contador_Calibrate == 3:
            ...
            self.B_Calibrate.config(bootstyle="danger", text="Siguiente")
