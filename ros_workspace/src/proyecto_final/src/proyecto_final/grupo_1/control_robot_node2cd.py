...
def control_callback(msg, control_robot):
    ...
    if action_code == 1:
        ...
        pose_goal = Pose()
        pose_goal.position.x = -0.064253
        pose_goal.position.y = 0.416105
        pose_goal.position.z = 0.325710
        pose_goal.orientation.x = 0.999468
        pose_goal.orientation.y = 0.030193
