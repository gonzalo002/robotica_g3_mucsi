...
class ImageProcessor_Top:
    ...
    def delete_aruco(self):
        '''
        Detecta un marcador Aruco en la imagen y lo elimina
        ...
        aruco_frame = deepcopy(self.frame)
        ...
        if ids is not None:
            ...
            self.frame = deepcopy(cv2.bitwise_and(self.frame, mask))
