...
class ImageProcessor_Planta:
    ...
    def filter_contours_by_size(self, filtered_contours):
        ...
        for contour in filtered_contours:
            ...
            if area > 4000:  # Filtrar contornos muy pequeños
...
if __name__ == "__main__":
    ...
    processor = ImageProcessor_Planta()
    frame = cv2.imread('src/proyecto_final/scripts/vision/Imagenes/Imagen_100.png')
